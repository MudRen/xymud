...
int topten_clear()
{
         string str;
	int i;
	string *f_name=({ TOPTEN_RICH, TOPTEN_PKER, TOPTEN_EXP, TOPTEN_DAOXING, TOPTEN_POTENTIAL, TOPTEN_SHEN1, TOPTEN_SHEN2, TOPTEN_neili, TOPTEN_AGE, TOPTEN_PER1, TOPTEN_PER2, });
	str="";
	for(i=0;i<11;i++)
