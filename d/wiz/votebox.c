...
void create()
{
        set_name( HIW"小雨西游"+HIR"投票箱"NOR, ({ "vote box"}) );
        set_weight(9999999);
        set("unit", "个");
        set("no_clean_up",1);
        set("long",HIM"为了小雨西游更好的发展，请投下您宝贵的一票，谢谢！"NOR);
        setup();
}
...
int do_look(string arg)
{
        ...
        write(HIW"小雨西游"HIR"投票箱"HIW",(请用choose 1|2|3..来投票,谢谢你支持小雨西游的发展!)\n"NOR);
        write(HIG"=========================================================================\n"NOR);
        if (!ob->query("vote_string") || !ob->query("choose_number"))
        {
                write(HIR"小雨西游暂时没有投票活动!\n"NOR);
                return 1;
        }
        write(HIY"本次投票内容\n"NOR);
...
int do_vote(string arg)
{
        ...
        write(HIM"谢谢您对小雨西游的衷心支持!GOOD LUCK!\n"NOR);
        return 1;
}
