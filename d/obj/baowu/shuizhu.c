                ...
                if( random(ap + dp) > dp )
                 {
                        ...
                        if( damage > 0 ) 
                        {
                                ...
                                target->receive_damage("sen", damage*4/5,who);
                                target->receive_wound("sen", damage/3,who);
                                target->receive_damage("kee", damage*4/5,who);
