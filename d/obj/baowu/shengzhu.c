...
被山石砸得皮破血流，还被风迷了双眼，又被水浇个透心凉，肌肤尽裂。\n" NOR;
                                ...
                                target->receive_damage("sen", damage*8/5,who);
                                target->receive_wound("sen", damage*2/3,who);
                                target->receive_damage("kee", damage*8/5,who);
                                target->receive_wound("kee", damage/2,who);
