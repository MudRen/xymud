...
void create()
{
  ...
  {
    case 0:
       { set_name(MAG "梦幻玫瑰" NOR, ({ "flower","dream flower"})); break; }
    case 1:
       { set_name(HIC "幻梦幽兰" NOR, ({ "flower","dream flower"})); break; }
    case 2:
      { set_name(HIB "薄雪花" NOR, ({ "flower", "dream flower"})); break; }
    case 3:
       { set_name(HIG "风野玫" NOR, ({ "flower","dream flower"})); break; }
    case 4:
       { set_name(HIR "美人血" NOR, ({ "flower","dream flower"})); break; }
    case 5:
       { set_name(HIW "青凰玫" NOR, ({ "flower","dream flower"})); break; }
    case 6:
...
int init ()
{
  ...
  call_out("need_water", 1000+random(1000), environment(this_object()));
  return 1;
}
