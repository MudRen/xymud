...
void create()
{
  ...
  set("class", "xian");
  set("daoxing", 28640000);
  set("kar", 30);

  set_skill("literate", 1600);
  set_skill("sword", 1680);
  set_skill("sanqing-jian",1640);
  set_skill("spells", 1700);
  set_skill("force", 1640);
...
void greeting(object who)
{
  ...
  if (who->query("dntg/huaguo")=="done"&&who->query("dntg/donghai")=="done"&&who->query("dntg/hell")=="done"&&
  	who->query("dntg/lijing")=="done"&&who->query("dntg/yaochi")=="done"&&who->query("dntg/bmw")=="done"&&
         who->query("dntg/erlang")=="done"&&who->query("dntg/pantao")=="done"&&who->query("dntg/laojun")=="done"
         &&who->query("dntg/number") != 10)
  who->set("dntg/number",9);
