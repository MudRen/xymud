...
void create()
{
	set_name("道臻", ({ "dao zhen", "zhen", "daozhen","changlao" }));
	create_family("蜀山派",3, "长老");
	set("title","律德长老");
        set("long","蜀山负责练气类功法传授，蜀山历史文献整理等工作的长老。\n");
        set("gender", "男性");
        set("age", 55);
...
int prevent_learn(object me, string skill)
{
	...
	string *noskill;
  	if( skill != "tundao")
  		return 0;
  	noskill = ({
		"jianshu","zhili","yufeng","jiee","yiyao","fushui","jiameng",
	});	
