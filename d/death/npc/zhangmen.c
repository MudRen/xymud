...
void create()
{
        set_name("大弟子", ({ "gui wang", "guiwang" ,"nu zhu" }) );
        set("gender", "男性" );
        set("age", 30);
        set("str", 30);
        set("per", 30);
...
int rank_me()
{
	...
	{
                if( exp <= 20000 ){
                          me->set("title", HIB"阎罗地府游魂"NOR);
		} else if(exp <= 50000 ){
                          me->set("title", HIB"阎罗地府小鬼卒"NOR);
		} else if(exp < 100000 ){
                          me->set("title", HIB"阎罗地府催命鬼卒"NOR);
		} else if(exp <= 1000000 ){
                          me->set("title", HIB"阎罗地府无情判官"NOR);
		} else if(exp <= 2000000 ){
                          me->set("title", HIB"十八地狱按查使"NOR);
		} else {
                          me->set("title", HIB"阎罗地府鬼族总领"NOR);
		}
