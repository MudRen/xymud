...
string ask_age()
{
        ...
        no = sizeof(ob) + 1;
        return me->name()+RANK_D->query_respect(me)+"的年龄在小雨西游目前中排名第"
                +chinese_number(no)+"。";
}
string ask_beauty()
{
        ...
        no = sizeof(ob) + 1;
        return me->name()+RANK_D->query_respect(me)+"的容貌在小雨西游目前中排名第"
 +chinese_number(no)+"。";
}
int ask_force()
{
        ...
        no = sizeof(ob) + 1;
        command("say "+me->name()+RANK_D->query_respect(me)+"的内力在小雨西游目前中排名第"
                +chinese_number(no)+"。");
        return 1;
}
int ask_spells()
{
        ...
        no = sizeof(ob) + 1;
        command("say "+me->name()+RANK_D->query_respect(me)+"的法力在小雨西游目前排名第"
 +chinese_number(no)+"。");
        return 1;
}
int ask_pk()
{
        ...
        no = sizeof(ob) + 1;
        command("say "+me->name()+RANK_D->query_respect(me)+"的杀害玩家数在小雨西游目前排名第"
                +chinese_number(no)+"。");
        return 1;
}
int ask_mk()
{
        ...
        no = sizeof(ob) + 1;
 command("say "+me->name()+RANK_D->query_respect(me)+"的杀害ＮＰＣ数在小雨西游目前排名第"
                +chinese_number(no)+"。");
        return 1;
}
int ask_exp()
{
        ...
        no = sizeof(ob) + 1;
        command("say "+me->name()+RANK_D->query_respect(me)+"的武学在小雨西游目前在线玩家中排名第"
                +chinese_number(no)+"。");
        message_vision(CYN "$N指着$n赞叹道：“"+me->name()+"是小雨西游中"HIC"第"
...
int ask_daoxing()
{
 ...
 ob = filter_array(ob,
        ...
        no = sizeof(ob) + 1;
        command("say "+me->name()+RANK_D->query_respect(me)+"的道行在小雨西游目前在线玩家中排名第"
                +chinese_number(no)+"。");
        message_vision(CYN "$N指着$n赞叹道：“"+me->name()+"是小雨西游中第"
                +HIC+chinese_number(no)+"高手"+NOR+CYN+"！”\n" NOR, this_object(), me);
        return 1;
}
