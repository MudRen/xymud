...
void create()
{
  ...
  set("per", 30);
  set("force_factor",710);
  set("mana_factor",710);

  set_skill("spells",710);
  set_skill("dao",710);
  set_skill("unarmed",710);
  set_skill("puti-zhi", 710);
  set_skill("dodge",710);
  set_skill("jindouyun",710);
  set_skill("qianjun-bang",710);
  set_skill("parry",710);
  set_skill("force",710);
  set_skill("wuxiangforce",710);
  set_skill("staff",710);
