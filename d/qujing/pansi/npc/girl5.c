...
void create()
{
  ...
  set("per", 30);
  set("force_factor",730);
  set("mana_factor",730);

  set_skill("spells",730);
  set_skill("dao",730);
  set_skill("unarmed",730);
  set_skill("puti-zhi", 730);
  set_skill("dodge",730);
  set_skill("jindouyun",730);
  set_skill("qianjun-bang",730);
  set_skill("parry",730);
  set_skill("force",730);
  set_skill("wuxiangforce",730);
  set_skill("staff",730);
