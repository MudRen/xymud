...
void create()
{
  ...
  set("per", 30);
  set("force_factor",740);
  set("mana_factor",740);

  set_skill("spells",740);
  set_skill("dao",740);
  set_skill("unarmed",740);
  set_skill("puti-zhi", 740);
  set_skill("dodge",740);
  set_skill("jindouyun",740);
  set_skill("qianjun-bang",740);
  set_skill("parry",740);
  set_skill("force",740);
  set_skill("wuxiangforce",740);
  set_skill("staff",740);
