...
int do_eat(string arg)
{
	...
	me->set("eff_sen", (int)me->query_maxsen());
  me->set("sen", (int)me->query_maxsen());
  me->set("eff_kee", (int)me->query_maxkee());
  me->set("kee", (int)me->query_maxkee());
  me->set("mana", (int)me->query_maxmana());
  me->set("force", (int)me->query_maxforce());
  me->set("food", (int)me->max_food_capacity());
  me->set("water", (int)me->max_water_capacity());
  message_vision(HIG "$N"HIG"将舍利子内丹含入嘴中咽下，一股仙气自丹田缓缓遍布全身了！\n" NOR, me);
  me->start_busy(5);
  destruct(dan);
  return 1;
}
