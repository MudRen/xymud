...
//    set("title", HIB"天庭通缉盗宝贼"NOR);
        ...
        carry_object("/d/obj/drug/jinchuang");
        carry_object("/d/obj/drug/jinchuang");
        carry_object("/d/obj/drug/lingzhi");
        add_money("gold", 5);
}
...
void die()
{
 ...
 /*
        ...
        tell_object(ob,"\n你杀死盗宝妖怪,天庭特赐你"+COMBAT_D->chinese_daoxing(reward)+"道行和" + reward/2 + "点潜能！\n" );
        MONITOR_D->report_system_object_msg(ob,"得到了"+COMBAT_D->chinese_daoxing(reward)+"道行和"  + reward/2 + "点潜能！");
*/
                ::die();
}
