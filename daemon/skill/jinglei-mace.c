...
if ( me->query("family/jjf_type") && me->query("family/jjf_type")!="mace" ) 
        return notify_fail("你既不是将军府鞭系亲兵，自然不能再学惊雷鞭法。\n");
	return 1;
}
