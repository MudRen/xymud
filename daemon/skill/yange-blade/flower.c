...
string *style_siqi = ({
        HIG "小苑莺歌歇－－$N"HIG"舒臂轻弹手中$w"HIG"，直刺$n"HIG"的$l！\n" NOR,
        HIG "长门蝶舞多－－$N"HIG"手中$w"HIG"化做流云，飘向$n"HIG"的$l！\n" NOR,
        HIG "眼看春又去－－$N"HIG"纤腰摆动，手中$w"HIG"似流水般袭向$n"HIG"的$l！\n" NOR,
        HIG "翠辇不曾过－－$N"HIG"手中$w"HIG"似重逾千斤，磕向$n"HIG"的$l！\n" NOR
});
/*
...
string *style_mix= ({
        HIG "小苑莺歌歇－－$N"HIG"舒臂轻弹手中$w"HIG"，直刺$n"HIG"的$l！\n" NOR,
        HIR "江山如画－－$N"HIR"纵身跃起，直上青天，手中$w"HIR"大力劈出，自上而下攻向$n"HIR"的$l！\n" NOR,
        HIG "长门蝶舞多－－$N"HIG"手中$w"HIG"化做流云，飘向$n"HIG"的$l！\n" NOR,
        HIR "余音袅袅－－$N"HIR"心神合一，刀力自手中$w"HIR"呼啸而出，狂奔$n"HIR"的$l！\n" NOR,
        HIG "眼看春又去－－$N"HIG"纤腰摆动，手中$w"HIG"似流水般袭向$n"HIG"的$l！\n" NOR
        HIR "声景交融－－$N"HIR"暴喝一声，手中$w"HIR"圈转，啸音反强，刀光啸音浑然一体，滚向$n"HIR"的$l！\n" NOR,
        HIG "翠辇不曾过－－$N"HIG"手中$w"HIG"似重逾千斤，磕向$n"HIG"的$l！\n" NOR,
});
...
if(FLAG)
        ...
        for(i=0;i<sizeof(style_mix);i++)
                {
                if ( !target || !me || !you || !me->is_fighting(target) )
                        continue;       
