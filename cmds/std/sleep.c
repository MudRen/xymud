...
int main(object me, string arg)
{
     ...
     if ( me->is_busy() || ( !userp(me) && me->query("no_sleep") )  )
        ...
        if(me->query("gender")=="男性"){
                ...
                obj->set("first_sleep",me->query("id"));
                me->set("first_sleep",obj->query("id"));
...
if ( environment(me) 
  && interactive(me) )
        {
        me->set_temp("new_id",1);
        me->move(environment(me),2);
        me->delete_temp("new_id");
        }
...
if(kee_cost>(int)me->query_maxkee()/2)        
        kee_cost=(int)me->query_maxkee()/2+1; 
